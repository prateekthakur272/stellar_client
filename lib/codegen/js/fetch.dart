...
import 'package:stellar_client/utils/utils.dart'
    ...
    try {
      ...
      String result = isNodeJs
          ...
          : requestModel.hasFileInFormData
              ? "// refer https://github.com/foss42/stellar_client/issues/293#issuecomment-1995208098 for details regarding integration\n\n"
              : "";
